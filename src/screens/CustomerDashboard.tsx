...
export const CustomerDashboard = ({ onNavigate }: { onNavigate: (s: Screen) => void }) => {
  return (
    <div className="pt-24 px-4 md:px-10 max-w-7xl mx-auto space-y-10 pb-32">
      {/* Profile Header */}
      <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-10 rounded-[40px] shadow-ambient border border-outline-variant/30">
         <div className="relative group">
            <div className="w-32 h-32 rounded-full ring-4 ring-secondary/20 p-2 overflow-hidden bg-surface-container-low transition-all group-hover:ring-secondary/40 shadow-xl">
            ...
            <button className="absolute bottom-2 right-2 p-3 bg-primary text-white rounded-full shadow-lg hover:bg-opacity-90 transition-all outline outline-4 outline-white">
               <Settings className="w-5 h-5" />
            </button>
         </div>
         <div className="text-center md:text-left space-y-2 flex-1">
            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 justify-center md:justify-start">
               <h1 className="text-4xl font-display font-bold text-primary">Ayo Balogun</h1>
            ...
            <p className="text-on-surface-variant font-medium">ayo.b@example.com • +234 812 345 6789</p>
         ...
         <div className="hidden lg:flex gap-4">
            <button className="p-4 bg-surface-container-low rounded-2xl hover:bg-surface-container-high transition-colors"><Bell className="w-6 h-6 text-primary" /></button>
      ...
      <div className="grid lg:grid-cols-3 gap-10">
         ...
         <div className="lg:col-span-2 space-y-12">
            ...
            <section className="space-y-6">
               ...
               <div className="bg-primary/5 border border-primary/10 rounded-3xl p-8 space-y-6 relative overflow-hidden group">
                  <div className="flex justify-between items-start">
                     <div className="space-y-1">
                        ...
                        <h3 className="text-xl font-bold text-primary">Order #VG-19283</h3>
                  ...
                  <div className="flex gap-3">
                     ...
                     <button className="text-primary font-bold text-sm hover:underline">Track Dispatcher →</button>
                  </div>
               </div>
            </section>
            ...
            <section className="space-y-6">
               ...
               <div className="bg-white rounded-3xl border border-outline-variant/30 shadow-ambient overflow-hidden">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="flex items-center justify-between p-6 border-b border-outline-variant/10 hover:bg-surface-container-low transition-colors cursor-pointer last:border-0 group">
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             ...
                             <p className="text-sm text-on-surface-variant mt-0.5">Apr {15-i}, 2024 • 2 Items</p>
                          </div>
                       </div>
                       <button className="btn-ghost py-2 px-4 text-xs h-fit opacity-0 group-hover:opacity-100 transition-opacity">Reorder</button>
                    </div>
                  ))}
               </div>
            </section>
         ...
         <div className="space-y-8">
            <div className="bg-secondary-fixed rounded-3xl p-8 space-y-6 shadow-ambient border border-secondary shadow-lg shadow-secondary/10 relative overflow-hidden group">
